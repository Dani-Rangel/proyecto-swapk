...
def upgrade() -> None:
    ...
    sa.Column('tipo', sa.Enum('individual', 'grupo', name='tipochat'), nullable=True),
    ...
    op.create_table('chat_usuarios',
    sa.Column('chat_id', sa.Integer(), nullable=False),
    sa.Column('usuario_id', sa.Integer(), nullable=False),
    sa.Column('estado', sa.String(length=20), nullable=True),
    sa.Column('fecha_unirse', sa.DateTime(timezone=True), nullable=True),
    sa.ForeignKeyConstraint(['chat_id'], ['chats.id'], ),
    sa.ForeignKeyConstraint(['usuario_id'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('chat_id', 'usuario_id')
    )
    ...
    sa.Column('id_usuario', sa.Integer(), nullable=True),
    sa.Column('contenido', sa.Text(), nullable=True),
    sa.Column('tipo', sa.Enum('Curso', 'Intercambio', 'Mensaje', 'Publicacion', 'comentario', name='tiponotificacion'), nullable=True),
    ...
    sa.Column('tipo', sa.Enum('Intercambio', 'Curso', 'Pregunta', 'Logro'), nullable=False),
    ...
    sa.Column('id_comentario_padre', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['id_comentario_padre'], ['comentarios.id'], ),
    ...
    sa.ForeignKeyConstraint(['id_usuario'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('id_usuario', 'id_publicacion', name='_usuario_publicacion_uc')
    )
    op.create_table('propuestas_intercambio',
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('id_intercambio', sa.Integer(), nullable=False),
    sa.Column('id_usuario_interesado', sa.Integer(), nullable=False),
    sa.Column('aceptada', sa.Boolean(), nullable=True),
    sa.Column('fecha_propuesta', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['id_intercambio'], ['intercambios.id'], ),
    sa.ForeignKeyConstraint(['id_usuario_interesado'], ['usuarios.id'], ),
    sa.PrimaryKeyConstraint('id')
    )
...
def downgrade() -> None:
    ...
    op.drop_table('propuestas_intercambio')
    op.drop_table('likes')
