...
interface ContactsSidebarProps {
  currentContact: string | null // (contact: string) => void
  onViewChange: (view: "video-call" | "chat" | "screen-share") => void
  currentView: string
  contacts?: Contact[] // recibimos los contactos desde props
}
...
export function ContactsSidebar({
  ...
  onViewChange,
  currentView,
  contacts = [] // Default vacío para evitar errores
  ...
  // Filtramos contactos según el buscador
      ...
      <div className="flex-1 overflow-y-auto">
        {filteredContacts.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-gray-500 text-sm p-4">
            <p className="text-center">Aún no tienes conversaciones.</p>
            <p className="text-center text-gray-400 mt-1">
              Cuando empieces a interactuar con otros usuarios, tus chats aparecerán aquí.
            </p>
          </div>
        ) : (
            ...
            >
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {contact.lastMessage && (
                    <p className="text-sm text-gray-400 line-clamp-2">{contact.lastMessage}</p>
                  )}
                </div>
